...
export const ACCENT_COLORS: RawAccentOption[] = [
  ...
  },
  {
    ...
    softBgDark: 'rgba(15, 23, 42, 0.40)',
    softBgLight: 'rgba(15, 23, 42, 0.08)',
    borderDark: 'rgba(255, 255, 255, 0.20)',
    borderLight: 'rgba(15, 23, 42, 0.25)',
    borderStrongDark: 'rgba(255, 255, 255, 0.40)',
    borderStrongLight: 'rgba(15, 23, 42, 0.60)',
    glowShadow: '0 0 20px rgba(15, 23, 42, 0.50)',
    foregroundDark: '#FFFFFF',
    foregroundLight: '#FFFFFF',
    ringDark: 'rgba(255, 255, 255, 0.30)',
    ringLight: 'rgba(15, 23, 42, 0.30)',
  },
  {
    id: 'white',
    name: 'White',
    ...
    softBgLight: 'rgba(255, 255, 255, 0.60)',
    borderDark: 'rgba(255, 255, 255, 0.45)',
    borderLight: 'rgba(203, 213, 225, 0.80)',
    borderStrongDark: 'rgba(255, 255, 255, 0.70)',
    borderStrongLight: 'rgba(148, 163, 184, 0.80)',
    glowShadow: '0 0 20px rgba(255, 255, 255, 0.40)',
    foregroundDark: '#0F172A',
    foregroundLight: '#0F172A',
    ringDark: 'rgba(255, 255, 255, 0.50)',
    ringLight: 'rgba(15, 23, 42, 0.25)',
  },
];

...
export function getSupabaseConfig(): SupabaseConfig {
  ...
  // Default project fallback provided by user
  const DEFAULT_URL = 'https://fxibrpkopxbcfudcabgk.supabase.co';
  const DEFAULT_KEY = 'sb_publishable_oedRsZMNstkwktaAXsSeFw_UCV54omc';
...
export const GOOGLE_CLIENT_ID = '556152838118-a97ftph3fsre69mi2la3e04sb62c5qs5.apps.googleusercontent.com';

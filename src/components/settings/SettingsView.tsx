  ...
  return (
    <div className={`flex-1 flex flex-col h-full overflow-y-auto p-4 sm:p-6 max-w-4xl mx-auto w-full transition-colors duration-200 ${
      ...
      <div className="space-y-4">
        {/* Appearance, Themes & Accent Colors (DARK MODE, LIGHT MODE, 10 ACCENTS INCLUDING BLACK & WHITE) */}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-[11px] ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                  Select your favorite accent color including Black, White, Emerald, and more
                </p>
              </div>
              <span 
                ...
                style={{
                  backgroundColor: currentAccent.hex,
                  color: accentColor === 'black' ? '#FFFFFF' : '#070A0F'
                }}
              >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5">
              {ACCENT_OPTIONS.map((c) => {
                ...
                return (
                  ...
                  >
                    <div 
                      className="w-7 h-7 rounded-full flex items-center justify-center shrink-0 shadow-md transition-transform group-hover:scale-110 border border-slate-700/50"
                      style={{ 
                    ...
                    >
                      {isSelected && (
                        <Check 
                          className={`w-4 h-4 stroke-[3] ${c.id === 'white' ? 'text-slate-900' : 'text-white'}`} 
                        />
                      )}
                    </div>
                    <div className="min-w-0">

      ...
      >
        ...
        <form onSubmit={handleSave} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-3 py-2.5 rounded-xl text-sm border focus:outline-none transition ${
                  isDark 
                    ? 'bg-slate-800/90 border-slate-700 text-white placeholder-slate-500 focus:border-blue-500' 
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-1">
              Registered phone number for contact discovery and identity.
            </p>
          </div>

          {/* 4. Connected Google Account (PERMANENTLY LOCKED & NOT EDITABLE) */}
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/20">
                <Lock className="w-2.5 h-2.5" /> Permanent & Locked
              </span>
            </div>
            <div className="relative">
              ...
              <input
                ...
                disabled
                readOnly
                value={currentUser.googleEmail || currentUser.email || 'Connected Google Account'}
                className="w-full pl-10 pr-3 py-2.5 rounded-xl text-sm border opacity-75 cursor-not-allowed bg-slate-800/50 border-slate-700/60 text-slate-200 font-mono select-none"
              />
            </div>
            <p className="text-[11px] text-slate-400 mt-1 flex items-center gap-1">
              <span>🔒 This Google account is permanently connected to this profile and cannot be edited or replaced.</span>
            </p>
          </div>

      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        ...
        <div className="flex flex-col items-center text-center p-4 rounded-3xl bg-slate-900/60 border border-slate-800">
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            {isDirectChat ? (partner?.username ? `@${partner.username}` : 'Direct Chat') : `${chatMemberIds.length} Members`}
          </p>
          {chat.description && (
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[10px] text-slate-400 truncate">{user.about || (user.username ? `@${user.username}` : '')}</div>
                      </div>
                    </div>

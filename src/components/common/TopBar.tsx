...
import { Users, Plus, WifiOff, Settings, RefreshCw, Share2 } from 'lucide-react';
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {onOpenShare && (
          <button
            ...
            id="btn-topbar-share"
          >
            <Share2 className="w-3.5 h-3.5" style={{ color: currentAccent.hex }} />
            <span className="hidden sm:inline">Share</span>
          </button>
        )}

        {/* New Group Button - Only visible in Community section */}
        {activeTab === 'communities' && onOpenNewGroup && (
          <button
